...
LRESULT CALLBACK hkGetMessage(int code, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_MOUSEMOVE:
        ...
        break;
    case WM_MOUSEWHEEL:
        if (list->MouseWheelHook) pass_msg = list->MouseWheelHook(GET_WHEEL_DELTA_WPARAM((int)msg->wParam), LOWORD(msg->lParam), HIWORD(msg->lParam), GET_KEYSTATE_WPARAM((int)msg->wParam));
        break;
    case WM_LBUTTONDOWN:
